...
var ParseQuery = function () {
  ...
  (0, _createClass2.default)(ParseQuery, [{
    ...
    value: function (callback, options) {
      ...
      return (0, _promiseUtils.continueWhile)(function () {
        ...
        return query.find(findOptions).then(function (results) {
          return Promise.resolve(callback(results)).then(function () {
      ...
      return _regenerator.default.async(function (_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 6:
              return _context3.abrupt("return", accumulator);
    ...
    key: "withinRadians",
    value: function (key, point, distance, sorted) {
    ...
    value: function () {
      ...
      keys.forEach(function (key) {
        ...
        _this7._order = _this7._order.concat(key.replace(/\s/g, '').split(','));
      });
      return this;
    }
  }, {
    ...
    value: function () {
      ...
      keys.forEach(function (key) {
        ...
        _this8._order = _this8._order.concat(key.replace(/\s/g, '').split(',').map(function (k) {
          return '-' + k;
        }));
      });
      return this;
    ...
    value: function () {
      ...
      keys.forEach(function (key) {
        if (Array.isArray(key)) {
          _this9._include = _this9._include.concat(key);
        } else {
      ...
      return _regenerator.default.async(function (_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 6:
              liveQueryClient = _context5.sent;
              ...
              return _context5.abrupt("return", subscription.subscribePromise.then(function () {
                return subscription;
              }));
